...
let UserServices = class UserServices {
    ...
    login(body) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!compare) {
                throw new appError_1.AppError("E-mail and password doesn't match", 403);
            }
            const token = jsonwebtoken_1.default.sign({ id: user.id }, process.env.JWT_SECRET, { expiresIn: "12h", });
            return {
                accessToken: token,
